    ...
    <section class="section position-relative" style="background-image: url(image/image-1920x900-5.jpg);">
        ...
        <div class="r-container position-relative h-100" style="z-index: 2;">
            <div class="d-flex flex-column gap-3">
                <h3 class="accent-color font-1 fw-semibold">Pediatric Chiropractic</h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('index') }}">Home</a></li>
                        <li class="breadcrumb active" aria-current="page">&nbsp;&nbsp;/ Pediatric Chiropractic</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col col-lg-12">
                    <div class="d-flex flex-column">
                        <h3 class="fw-semibold font-1">Pediatric Chiropractic</h3>
